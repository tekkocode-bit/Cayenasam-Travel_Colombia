...
export function buildRealToursCatalog() {
  return [
    { key: "tour_antioquia", id: "rt_col_tour_antioquia", title: "Tour por Antioquia", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624106/Tour_por_Antioquia_cfafvq.jpg", leadOnly: true },
    { key: "guatape_piedra_penol", id: "rt_col_guatape", title: "Guatapé - Piedra del Peñol", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624090/Guatape_fx9erp.jpg", leadOnly: true },
    { key: "napoles_santorini_2dias", id: "rt_col_napoles_santorini", title: "Parque Temático Nápoles + Santorini Antioqueño", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624097/Parque_tematico_napoles_g0ld4r.jpg", leadOnly: true },
    { key: "ruta_de_la_leche", id: "rt_col_ruta_leche", title: "Ruta de la Leche", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624093/la_ruta_de_la_leche_q9hm4q.jpg", leadOnly: true },
    { key: "concepcion_el_canelo", id: "rt_col_concepcion", title: "Concepción - El Canelo", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624103/Concepcion_el_canelo_1_dia_weh3un.jpg", leadOnly: true },
    { key: "jardin_hispania_andes", id: "rt_col_jardin", title: "Jardín - Hispania y Andes", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624089/Jardin_hispana_y_andes_iktzrq.jpg", leadOnly: true },
    { key: "buga_termales", id: "rt_col_buga_termales", title: "Buga y Los Termales", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624092/Buga_y_los_termales_rjvs3i.jpg", leadOnly: true },
    { key: "termales_espiritu_santo", id: "rt_col_termales_espiritu", title: "Termales del Espíritu Santo", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624110/Termales_del_espiritu_vvclsi.jpg", leadOnly: true },
    { key: "pueblos_encanto_suroeste", id: "rt_col_pueblos_encanto", title: "Pueblos de Encanto del Suroeste Antioqueño", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624108/pueblos_de_encanto_urikmi.jpg", leadOnly: true },
    { key: "santorini", id: "rt_col_santorini", title: "Santorini con Día de Sol o Rafting", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624101/Santorini_oft3c0.jpg", leadOnly: true },
    { key: "cisneros", id: "rt_col_cisneros", title: "Cisneros - Entre Rieles y Montañas", groupKey: "tours_colombia", imageUrl: "https://res.cloudinary.com/daqqrtg0b/image/upload/v1774624095/Cisneros_ouv8pd.jpg", leadOnly: true },
